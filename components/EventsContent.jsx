...
export default class EventsContent extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        { this.props.selectedTeam ? <p>return to <b><a className="clickable" onClick={() => {this.props.setTeam(0); this.props.showTeams(); this.props.hideCountries()}}>{this.props.selectedCountry}</a></b></p> : null}
